      ...
      <div className="container">
        ...
        >
          ...
          <div className="edu-content">
            <span className="edu-period">Mar. 2020 – Present</span>
            <h4 className="edu-school">Yonsei University</h4>
            <p className="edu-degree">Biochemistry &amp; Computer Science (Double Major)</p>
            <div className="edu-details">
              <span className="edu-gpa">
                <i className="fas fa-star" /> GPA: 3.91 / 4.3 &nbsp;·&nbsp; CS Major GPA: 4.0 / 4.3
              </span>
